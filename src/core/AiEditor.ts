...
export class AiEditor {
    ...
    private initInnerEditor() {
        ...
        if (header) {
            this.header = isElement(header) ? header as Header : document.createElement("aie-header") as Header;
            this.eventComponents.push(this.header);
        } 

        if (footer) {
            this.footer = isElement(footer) ? footer as Footer : document.createElement("aie-footer") as Footer;
